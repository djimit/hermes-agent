...
class AIAgent:
    ...
    def _anthropic_preserve_dots(self) -> bool:
        ...
        return (
            base_url_host_matches(base, "aliyuncs.com")
            or base_url_host_matches(base, "minimax.io")
            or base_url_host_matches(base, "minimaxi.com")
            or base_url_host_matches(base, "opencode.ai")
    ...
    if save_sample:
        ...
        try:
            with open(sample_filename, "w", encoding="utf-8") as f:
                ...
                f.write(redact_sensitive_text(json.dumps(entry, ensure_ascii=False, indent=2), force=True))
